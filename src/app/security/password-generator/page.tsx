...
export default function PasswordGeneratorPage() {
    ...
    return (
        // ... return 이하 JSX 부분은 이전과 동일합니다 ...
        <div className="container mx-auto px-4 py-8">
            <div className="text-center mb-8">
                <h1 className="text-4xl font-black tracking-tighter">비밀번호 생성기</h1>
                <p className="text-lg text-gray-600 mt-2">강력하고 안전한 비밀번호를 생성하여 당신의 계정을 보호하세요.</p>
            </div>
            ...
            <div className="max-w-xl mx-auto">
                ...
                <button onClick={generatePassword} className="w-full mt-4 px-6 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 transition-colors shadow-md">새 비밀번호 생성</button>
